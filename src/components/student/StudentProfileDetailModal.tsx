          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-blue-200 font-medium">
                Roll No: <span className="font-bold text-white uppercase">{student.roll_number}</span> • {student.department}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-slate-50 border border-slate-200/80 p-3.5 rounded-2xl text-center">
              <span className="text-xs font-semibold text-slate-500 block">Total Assigned</span>
            ...
            <div className="bg-emerald-50 border border-emerald-100 p-3.5 rounded-2xl text-center">
              ...
              <span className="text-xl font-black text-emerald-700">{completedTasks.length}</span>
            </div>
            <div className="bg-blue-50 border border-blue-100 p-3.5 rounded-2xl text-center">
              <span className="text-xs font-semibold text-blue-600 block">Progress</span>
              <span className="text-xl font-black text-blue-700">{completionRate}%</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 flex items-center gap-1.5">
              ...
              My Department Submissions History ({completedTasks.length})
            </h3>
                  ...
                  >
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[11px] text-slate-500">
                        Submitted on: <span className="font-medium text-slate-700">{formatDate(t.completed_at || t.submission_submitted_at)}</span>
                      </p>
                    </div>
